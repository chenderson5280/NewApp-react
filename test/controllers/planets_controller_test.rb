...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { lifespan: @planet.lifespan, name: @planet.name } }, as: :json
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { lifespan: @planet.lifespan, name: @planet.name } }, as: :json
    assert_response 200
  end
